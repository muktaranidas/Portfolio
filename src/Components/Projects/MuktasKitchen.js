...
import categories from "../../assets/projects/kitchen/categories.jpg";
import details from "../../assets/projects/kitchen/details_review.PNG";
import allReview from "../../assets/projects/kitchen/allReview.PNG";
import addService from "../../assets/projects/kitchen/AddService.PNG";
          ...
          <div className="flex flex-col px-6 py-8 space-y-6 rounded-sm sm:p-8 lg:p-12 lg:w-1/2 xl:w-2/5 dark:bg-violet-400 dark:text-gray-900">
            ...
            <div className="flex space-x-2 sm:space-x-4">
              ...
              <div className="space-y-2">
                ...
                <p className="leading-snug">
                  This project is about give review on food. <br />
                  <br /> This project includes a React.js frontend and a
                  back-end server in Node. <br /> <br /> A MongoDB database is
                  used to store the data and uses Firebase for authentication
                  and also JWT security system. <br />
                  <br /> Client side host in firebase and server side host in
                  vercel
                </p>
              </div>
            </div>
            <div className="flex space-x-2 sm:space-x-4">
              <div className="space-y-2">
                <p className="text-lg font-medium leading-snug">
                  <a
                    onClick={() =>
                      openInNewTab("https://my-kitchen-8b2f9.web.app/")
                    }
                    href="#_"
                  ...
                  <a
                    onClick={() =>
                      openInNewTab(
                        "https://github.com/muktaranidas/Mukta-s-Kitchen"
                      )
                    }
                    href="#_"
                    class="relative inline-block text-lg group m-2"
                  ...
                  <a
                    onClick={() =>
                      openInNewTab(
                        "https://github.com/muktaranidas/Mukta-s-Kitchen-Server"
                      )
                    }
                    href="#_"
                    class="relative inline-block text-lg group m-2"
                ...
                <div className="space-y-2">
                  <a rel="noopener noreferrer" href="#" className="block">
                    <h3 className="text-xl font-semibold dark:text-violet-400">
                      Food Categories Details And Review Section
                    </h3>
                  </a>
                </div>
              </div>
