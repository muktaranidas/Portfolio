...
const Skills = () => {
  ...
  return (
    <div className="my-32" id="skills">
      ...
      <div className="pr-4">
        <div className="grid grid-cols-2 gap-32   skills-ul font-bold text-white">
          <ul>
            ...
            <li className="react my-8 text-pink-500">
              {" "}
              React
              {/* <svg
          ...
          <ul>
            ...
            <li className="jquery  my-8  text-pink-500">JQuery</li>
            <li className="redux  my-8  text-pink-500">Redux</li>
